...
export default function ActiveUpgradeMenu(props) {
  ...
  return (
    <ul className="menu-scene">
      {upgradeArray.map((upgrade, index) => (
        <UpgradeButton
          key={index}
          index={index}
          info={upgrade}
